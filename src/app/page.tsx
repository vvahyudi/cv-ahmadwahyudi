...
export default function Home() {
	return (
		...
		>
			{/* about */}
			<section>
				<h1 className={cn(sourcesans.className)}>{resumeData.name}</h1>
			...
			{/* skills */}
			<section>
				<h2 className={cn(sourcesans.className)}>Skills</h2>
			...
			{/* work experience */}
			<section>
				<h2 className={cn(sourcesans.className)}>Work Experience</h2>
			...
			{/* education */}
			<section>
				<h2 className={cn(sourcesans.className)}>Education</h2>
			...
			{/* projects */}
			<section>
				<h2 className={cn(sourcesans.className)}>Projects</h2>
